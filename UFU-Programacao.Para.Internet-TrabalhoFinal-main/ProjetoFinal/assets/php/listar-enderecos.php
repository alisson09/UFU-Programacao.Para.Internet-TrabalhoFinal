...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item disabled" href="./listar-enderecos.php">Endereços</a></li>
    ...
    <main>
        ...
        <h2 class="subtitle">Listagem dos endereços cadastrados</h2>
        <div class="table-responsive-sm">
        <table class="table table-striped">
            <thead class="thead-dark">
                <tr>
                    <th class="col-3" scope="col">CEP</th>
                    <th class="col-3" scope="col">Logradouro</th>
                    <th class="col-3" scope="col">Cidade</th>
                    <th class="col-3" scope="col">Estado</th>
                </tr>
            </thead>
            <tbody>    
                <?php
