...
<body>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item disabled" href="./listar-todos-agendamentos.php">Todos Agendamentos</a></li>
    ...
    <main>
        ...
        <h2 class="subtitle">Listagem de todos os agendamentos</h2>
        ...
        <table class="table table-striped">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th class="col-1" scope="col">Horário</th>
                    <th class="col-3" scope="col">Nome</th>
                    <th class="col-1" scope="col">Sexo</th>
                    <th class="col-3" scope="col">Email</th>
                    <th class="col-1" scope="col">Código Médico</th>
                </tr>
            </thead>
            <tbody>    
                <?php
