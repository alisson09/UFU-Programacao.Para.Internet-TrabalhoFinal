...
<body>
    ...
    <main>
        <div class="container-aviso">
            <h2 class="subtitle">Acesso Negado</h2>
            <p>
                Lamentamos, mas o seu nível de acesso não é válido para a página procurada.
            </p>
            <a href="inicio.php" class="btn btn-info">Retornar ao Início</a>
        </div>
    </main>
    <footer>
