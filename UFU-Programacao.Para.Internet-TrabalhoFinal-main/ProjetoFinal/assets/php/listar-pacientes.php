...
try {
  ...
  $sql = <<<SQL
  SELECT peso, altura,tiposanguineo, nome, sexo
...
<body>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="./listar-funcionarios.php">Funcionários</a></li>
                                <li><a class="dropdown-item disabled" href="./listar-pacientes.php">Pacientes</a></li>
    ...
    <main>
        ...
        <h2 class="subtitle">Listagem dos pacientes cadastrados</h2>
        <div class="table-responsive-sm">
        <table class="table table-striped">
            <thead class="thead-dark">
                <tr>
                    <th class="col-4" scope="col">Nome</th>
                    <th class="col-2" scope="col">Peso</th>
                    <th class="col-2" scope="col">Altura</th>
                    <th class="col-2" scope="col">Tipo Sanguineo</th>
                    <th class="col-2" scope="col">Sexo</th>
                </tr>
            </thead>
            <tbody>    
                <?php
